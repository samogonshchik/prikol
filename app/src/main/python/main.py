...
# loading words from json and preparing dict for CrosswordGenerator constructor
...
cw_gen = CWG.CrosswordGenerator(_vocab=words, _dictionary=all_words, _layout=1)
cw_gen.generate()
board = cw_gen.board
